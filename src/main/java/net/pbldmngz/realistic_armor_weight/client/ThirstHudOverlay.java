package net.pbldmngz.realistic_armor_weight.client;
...
public class ThirstHudOverlay implements HudRenderCallback {
    private static final Identifier FILLED_THIRST = new Identifier(RealisticArmorWeight.MOD_ID,
            "textures/thirst/filled_thirst.png");
    private static final Identifier EMPTY_THIRST = new Identifier(RealisticArmorWeight.MOD_ID,
