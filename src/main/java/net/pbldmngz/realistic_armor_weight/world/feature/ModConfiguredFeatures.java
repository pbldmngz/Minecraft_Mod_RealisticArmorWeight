package net.pbldmngz.realistic_armor_weight.world.feature;
...
public class ModConfiguredFeatures {
    ...
    public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, new Identifier(RealisticArmorWeight.MOD_ID, name));
    }
